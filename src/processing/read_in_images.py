...
def create_data_for_model(clim_div):
    images_ls = []
    all_files = os.listdir('/home/aevans/nwp_bias/src/machine_learning/data/images')
    ...
    master_df = pd.read_csv(f'/home/aevans/nwp_bias/src/machine_learning/data/images/{df[0]}')
